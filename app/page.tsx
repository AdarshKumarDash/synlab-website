  ...
  const getLabelClasses = (value: string) =>
    ...
    return (
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="hidden dark:block absolute inset-0 -z-10 bg-black">
          <div
        ...
        <div
          className="block dark:hidden absolute inset-0 -z-10 
                      bg-gradient-to-br from-white via-neutral-100 to-neutral-200"
        >
          <div
            className="absolute -top-32 -left-32 w-[500px] h-[500px] 
                        bg-indigo-300/40 blur-[120px]"
          />
          <div
            className="absolute bottom-0 right-0 w-[400px] h-[400px] 
                        bg-pink-200/40 blur-[100px]"
          />
        </div>
        <main className="scroll-smooth snap-y snap-mandatory min-h-screen pt-[72px] relative overflow-x-hidden text-white">
          ...
          <section className="min-h-[calc(100vh-72px)] snap-start px-6 md:px-16 py-12 md:py-0 flex items-center relative">
            ...
            <div className="absolute inset-0 -z-10 overflow-hidden">
             ...
             bg-red-600/30 blur-[140px]"
              ...
              {/* Dark overlay to separate from page bg */}
            ...
            <div className="w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              <div className="flex flex-col justify-center h-full">
                ...
                >
                  ...
                  experimentation, technology, and guided knowledge come
                  together seamlessly.
                </motion.p>
              </div>
